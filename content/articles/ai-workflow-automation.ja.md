...
**結論から**：「AIを導入した」と「業務フローに組み込まれている」は別物です。分かれ目は**AIに任せる工程と、人が最終確認する工程を先に線引きしているか**の一点。公表されている3例は、どれも成果物・照合・承認のどこかに人を残しています。線引きしないまま入れると、**誰も出力を検証しない**か、**毎回人が作り直して手間が減らない**かのどちらかになります。
...
| 事例 | AIに任せた工程 | 人が残っている工程 |
|---|---|---|
| **パナソニック コネクト** | 作業の依頼先が広がった | **成果物という形で人の目に触れる** |
| **レンタルのニッケン** | 読み取り後の照合まで自動化 | **支払いの実行**は既存のシステム・体制の中 |
| **三菱UFJ銀行** | 稟議の**ドラフト作成**まで | **承認そのもの**は人 |
...
- 「導入した」と「組み込まれている」は別物。後者は**日々の手順にAIの工程が入り、人がそれを前提に動いている**状態
- 3例に共通するのは、**AIに任せる工程と人が最終確認する工程を先に線引き**していること。成果物・照合・承認のどこかに人が残っている
- 線引きしないと2つのどちらかに陥る — **誰も出力を検証しない**（誤りが外に出る）か、**毎回人が作り直す**（手間が減らない）
- **一工程だけを見て設計しない。** その前に何が起きて、後にどこへつながるかまで含めて見直す
- 定着しない原因は技術ではなく設計。**人の判断が必要な工程まで自動化の対象に入れる**、**例外処理の担当を決めないまま稼働させる**の2つ

どの業務から始めるかは[中小企業が最初にAI化すべき業務の見つけ方](../ai-first-step-smb/)に、エージェントに任せる範囲は[AIエージェントとは何か](../ai-agent-what-is/)に整理しています。
...
**工程を実際に繋いで無人で回す段になると、難所は工程そのものではなく繋ぎ目に移ります。** 当社が8工程を毎日無人で回している構成と、そこで実際に壊れた4か所は[AIエージェントのワークフローを組む — 毎日無人で回している8工程の設計と、実際に壊れた4か所](../ai-agent-workflow-build/)に、定着しない場合の切り分けは[導入したAIツールが使われない](../ai-tool-not-adopted/)に書いています。

---

出典：
- [パナソニックコネクト、「聞く」から「頼む」へシフトしたAI活用で年間44.8万時間の削減を達成](https://news.panasonic.com/jp/press/jn250707-2)（パナソニック ニュースルーム ジャパン）
- [SansanのBill One活用により国内250拠点の仕入請求書の処理を自動化](https://www.rental.co.jp/news/newsrelease/251016-01.html)（株式会社レンタルのニッケン ニュースリリース＝導入企業自身の発表）
