...
**結論から**：AI翻訳で数字が出ているのは「**量が多く、誤訳の影響が小さい**」文書です。1日4,500万〜5,500万文字を人のチェックなしで配信している例や、翻訳チェック業務の廃止で年間15万ドル削減した例があります。一方で**契約書・特許のように一語が法的意味を左右する文書と、広告コピーのように意訳が要る文書は、人の最終チェックを外せません**。分かれ目は「翻訳の頻度」と「誤訳が起きたときの影響の大きさ」の2軸です。
...
| 文書の種類 | AI翻訳の扱い | 理由 |
|---|---|---|
| 社内資料・大量の定型文 | **そのまま使える**ことが多い | 量が多く、誤訳が起きても影響が限定的 |
| **契約書・特許文書** | 下訳として使い、**専門知識を持つ人が最終チェック** | 一語の解釈が法的な意味を左右する |
| **広告コピー・ブランドメッセージ** | AI翻訳だけでは対応しきれない | 直訳では意図が伝わらず、文化的背景を踏まえた意訳が要る |
| 社内の略語・業界特有の言い回し | **用語集に登録**してから使う | 汎用の翻訳AIでは訳語がぶれる |
...
- 数字が出ているのは「**量が多く、誤訳の影響が小さい**」文書。1日4,500万〜5,500万文字を人のチェックなしで配信する例、翻訳チェック業務の廃止で**年間15万ドル削減**した例がある
- **契約書・特許**（一語が法的意味を左右する）と**広告コピー**（意訳が要る）は、人の最終チェックを外せない
- 社内の略語や業界用語は**用語集に登録**してから使う。しないと訳語がぶれ、読み手が誤解しないよう都度確認する手間が発生する
- 判断の2軸は「**翻訳の頻度**」と「**誤訳が起きたときの影響の大きさ**」
- 利用者が広がるほど訳文の品質にばらつきが出る。**重要な対外文書だけは特定の担当者が目を通す**、という簡単なルールを最初に決めておく

当社自身も1,000件超をAI翻訳で公開していますが、**日→英だけは載せない**と決めています。その理由は[AI翻訳で1,000件超を公開している自社メディアが、日→英だけは「載せない」と決めた理由](../toe-ai-output-check/)に書きました。ツールの選び方は[AIツールの選び方](../ai-tool-selection/)にあります。
