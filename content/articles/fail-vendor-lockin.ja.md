...
**結論から**：米国企業の経営幹部500人への調査では、**74%が主要なAIベンダーへの依存で「日常業務に支障が出る」以上**と答えています。そして**89%が「4週間以内に別ベンダーへ移行できる」と考えている**一方、実際に移行を試みた企業でスムーズにいったのは**42%だけ**でした。見通しと実態のあいだに差があります。中小企業でも打てる手はあり、要点は「**止まったときの人手の代替手順を残しておく**」ことです。
...
| 備え | 中身 |
|---|---|
| **代替手順を残す** | サービスが止まったとき、その業務を一時的にどう回すか。完全自動化の前の**人の手による手順**を消さずに残しておく |
| **固有機能に寄りかかりすぎない** | 業務上重要な処理は、特定サービス固有の機能への依存を抑える。プロンプトやデータを**汎用性の高い形**で管理しておくと移行の負担が減る |
| **ステータスページを把握** | 契約しているサービスの障害情報をどこで見るか、事前に確認しておく |
...
- 経営幹部500人の調査で、**74%が主要ベンダーへの依存で「日常業務に支障が出る」以上**（主要機能に支障47%＋業務の大部分を依存27%）
- **89%が「4週間以内に移行できる」と考えている**が、実際に移行を試みてスムーズにいったのは**42%**。残り58%は失敗したか想定よりはるかに手間がかかった
- **見通しと実態に差がある。** 移行の容易さは、試すまで分からない
- 打てる手は3つ — **人手の代替手順を残す／固有機能に寄りかかりすぎない／ステータスページを把握する**
- 自社で確認するのは「**そのサービスが止まったら完全に停止する業務があるか**」。あれば、数時間〜半日の代替手順を簡単でよいので用意する

止まった自動化に気づけなかった記録は[止まったメディア更新を、見張り役が自動で叩き起こしていた話](../toe-media-watchdog/)に、ツールの選び方は[AIツールの選び方](../ai-tool-selection/)にあります。
