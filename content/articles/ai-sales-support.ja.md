...
図面・測量関連のソフトウェアを扱う株式会社インフォマティクスは、AI音声解析サービス「bellSalesAI」を導入し、商談要点の整理と議事録作成にかかる工数を約50%削減したと公表しています。あわせて、対面営業活動のSalesforceへの登録件数が前年同期比で約20%増加したとも発表しています（出典：ATPRESS、https://www.atpress.ne.jp/news/581172）。入力の手間が減ったことで、そもそも記録に残す商談自体が増えたと読み取れます。
...
大塚商会は、20年以上蓄積した商談データと売上明細データをもとに、営業担当者へ訪問先候補を自動提案する「AI行き先案内」を導入しています。dotDataの分析基盤による事例紹介によると、AIが提案した商談は導入から1年で約3倍の7万4300件に増加し、全体の商談件数も四半期ベースで8.4%増加したと報告されています。また、AIモデルの元になる特徴量設計にかかる期間も、従来の数カ月から数日に短縮されたとされています（出典：dotData導入事例、https://jp.dotdata.com/resources/case-study/how-otsuka-shokai-increased-their-business-deals/）。
...
パナソニック コネクトのように、生成AIを全社員に開放し、2024年に年間44.8万時間の業務時間削減を達成したと公表している企業もあります（出典：Panasonic Newsroom Japan、https://news.panasonic.com/jp/press/jn250707-2）。ただしこの数字はプログラミングや資料作成、社内問い合わせ対応などを含む全社的な効果であり、営業活動に限定した数字ではない点には注意が必要です。
