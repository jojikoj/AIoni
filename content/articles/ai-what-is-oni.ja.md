...
強みは、**一般論・定説を出させると、モデルが違っても安定して同じ良質な答えが返る**こと。用語の解説、王道の考え方、定番の手順——こういう「みんなが知っている正解」を求める用途では、AIは頼れます。とはいえモデルごとの“温度”や向き不向きは残るので、選び方は[生成AIのモデルはどう選ぶか](../ai-model-selection/)にまとめています。

弱みは、**同じ問いを何度、何体に投げても、出てくるのは“平均的な正解”に寄る**こと。裏を返せば、他社と差がつく尖ったアイデアや、あなたの会社にしかない事情をふまえた発想は、そのままでは出てきません。3体に同じ人生相談を投げても着地がほぼ揃ったのも同じ現象です（[AIに「背中を押して」と頼んだら、3体とも冷や水を浴びせてきた](../ai-life-consultation-3models/)）。AIに詩を書かせると3体とも似た詩になるように、企画をそのまま丸投げすれば、競合と似た企画になります。AIの答えを“出発点”にして、そこから自分の固有の事情でどれだけ跳べるか——差がつくのはその一手間です。そもそも渡す指示が薄いと出力がどこまで平均に寄るかは[AIに「あ」とだけ送ったら、3体はどう反応したか](../ai-single-char-prompt/)で見られます。
