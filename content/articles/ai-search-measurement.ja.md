...
これが「出てこない、出てくるのはポータルサイトや大手メディアだけ」なら、中小企業が自社サイトを直す意味は薄いことになります。逆に「出てくる」なら、何が出る側と出ない側を分けているのかを知る価値があります。AI検索対策を売る当社が自社を同じ観点で測った結果は[AI検索対策を売る会社が自社を測ったら10点だった](../toe-own-visibility-10/)に書いています。
...
ポータル側で出てきたのは `mono.ipros.com`（イプロス）や `ja.nc-net.or.jp`（NCネットワーク）といった、製造業では有名な掲載サイトです。別のAI（Gemini＋検索）で福岡県の金属加工業45社が説明できるかを測った実測は[福岡県の金属加工業45社をAIに聞いたら、42社は説明できた](../kansoku-fukuoka-kinzoku-45/)にまとめています。
...
Ahrefsの実験は対照群を置いた比較で、方法論が公開されています。**現時点でこの領域で最も堅牢な検証です。** 構造化データがAI検索に効くのかという論点そのものは[構造化データ（schema.org）は、AI検索に効くのか](../aeo-structured-data/)でも整理しています。 一方、「構造化データで引用44%増」「3.1倍」といった肯定的な数字を出しているのは、調べた範囲では**すべてAI検索対策を売っている業者の自社ブログで、方法論が開示されていませんでした。**
