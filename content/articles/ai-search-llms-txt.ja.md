...
では、実際にどれくらいのサイトが入れているのか。**それを確かめるために、25サイトの `/llms.txt` を機械的に取得しました。** 同じ25サイトが、AIクローラ自体を許可しているか拒否しているかは[主要25サイトのrobots.txtで、AIクローラは拒否されているか許可されているか](../ai-crawler-robots/)で測っています。
