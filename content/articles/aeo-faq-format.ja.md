...
なお当社が自社サイトで測ったところ、構造化データは完備しているのに**リッチリザルトとしての表示回数は0回**でした。ただしこれは表示回数そのものが少なすぎて統計が溜まっていないだけの可能性が高く、**「効かない」ではなく「まだ何とも言えない」**が正確な言い方です（[構造化データ（schema.org）は、AI検索に効くのか](../aeo-structured-data/)）。型としての読みやすさと、機械可読の効果は分けて考えてください。検索結果でクリックされるかどうかは、別の要因で決まります（[1ページ目に155ページ出ているのに、140ページはクリック0だった](../toe-ctr-zero-clicks/)）。
