---
title: AIを単発タスク利用企業2%、全社展開企業23%。差はツール選定か、適用範囲か？
description: OECDの2026年調査から、AIの適用範囲と効果報告の関係を実測値で解きほぐします。単発タスク利用企業2%、全社展開企業23%。ただし標本の特性と因果推論の限界、セキュリティとの関係まで含めた読み方を整理。
